...
public class SimuladorTest extends BaseTest {
    ...
    public void Simular() throws InterruptedException {
        ...
        completarEntrevista.IdentificacionPersona ( "C.U.I.L.", "23353071459 " );
        //Entrevista
        completarEntrevista.Modalidad ( "Presencial" );
        completarEntrevista.ActividadLaboral ();
        completarEntrevista.DatosDelNegocio ();
        completarEntrevista.DatosPersonales ();
        completarEntrevista.DatosContacto ();
        completarEntrevista.CuentaDebito ();
        completarEntrevista.Ingresos ( "Dependiente" );
        completarEntrevista.Confirmar ();
        completarEntrevista.Cerrar ();
    }
}
